...
class Tile {
  ...
  draw() {
    this._2D_CTX.drawImage(this.img,
      this.XClipPoint, this.YClipPoint, this.XClipPointEnd, this.YClipPointEnd,
      this.drawPosX, this.drawPosY, this.width, this.height);
  }
}
